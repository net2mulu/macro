...
export default function Chatbot() {
  ...
  >([
    {
      type: "bot",
      text: "Hello! I'm MACRO's AI assistant. How can I help you today? I can answer questions about our services, projects, or direct you to the right contact.",
    },
  ]);
